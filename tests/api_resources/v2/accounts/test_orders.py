...
class TestOrders:
    ...
    def test_method_get_fee_quote(self, client: Dinari) -> None:
        order = client.v2.accounts.orders.get_fee_quote(
            account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            chain_id="eip155:1",
        ...
        assert_matches_type(OrderGetFeeQuoteResponse, order, path=["response"])
    ...
    def test_raw_response_get_fee_quote(self, client: Dinari) -> None:
        response = client.v2.accounts.orders.with_raw_response.get_fee_quote(
            account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            chain_id="eip155:1",
            contract_address="contract_address",
            order_side="BUY",
    ...
    def test_streaming_response_get_fee_quote(self, client: Dinari) -> None:
        with client.v2.accounts.orders.with_streaming_response.get_fee_quote(
            account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            chain_id="eip155:1",
            contract_address="contract_address",
            order_side="BUY",
    ...
    def test_path_params_get_fee_quote(self, client: Dinari) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            client.v2.accounts.orders.with_raw_response.get_fee_quote(
                account_id="",
                chain_id="eip155:1",
                contract_address="contract_address",
                order_side="BUY",
...
class TestAsyncOrders:
    ...
    async def test_method_get_fee_quote(self, async_client: AsyncDinari) -> None:
        order = await async_client.v2.accounts.orders.get_fee_quote(
            account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            chain_id="eip155:1",
            contract_address="contract_address",
            order_side="BUY",
    ...
    async def test_raw_response_get_fee_quote(self, async_client: AsyncDinari) -> None:
        response = await async_client.v2.accounts.orders.with_raw_response.get_fee_quote(
            account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            chain_id="eip155:1",
            contract_address="contract_address",
            order_side="BUY",
    ...
    async def test_streaming_response_get_fee_quote(self, async_client: AsyncDinari) -> None:
        async with async_client.v2.accounts.orders.with_streaming_response.get_fee_quote(
            account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            chain_id="eip155:1",
            contract_address="contract_address",
            order_side="BUY",
    ...
    async def test_path_params_get_fee_quote(self, async_client: AsyncDinari) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            await async_client.v2.accounts.orders.with_raw_response.get_fee_quote(
                account_id="",
                chain_id="eip155:1",
                contract_address="contract_address",
                order_side="BUY",
