...
__all__ = [
    ...
    "PaginatedAccountOrderRequestResponseData",
    "PaginatedAccountOrderRequestResponsePaginationMetadata",
]
...
class PaginatedAccountOrderRequestResponseData(BaseModel):
    """A request to create an `Order`.
...
class PaginatedAccountOrderRequestResponsePaginationMetadata(BaseModel):
    """Pagination metadata"""
...
class PaginatedAccountOrderRequestResponse(BaseModel):
    data: List[PaginatedAccountOrderRequestResponseData]
    """List of AccountOrder"""

    pagination_metadata: PaginatedAccountOrderRequestResponsePaginationMetadata
    """Pagination metadata"""

    api_sv: Optional[Literal["PaginatedAccountOrderRequestResponse:v1"]] = FieldInfo(alias="_sv", default=None)
    """Version"""


OrderRequestListResponse: TypeAlias = Union[List[UnionMember0], PaginatedAccountOrderRequestResponse]
