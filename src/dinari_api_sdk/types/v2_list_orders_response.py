...
__all__ = [
    ...
    "PaginatedEntityOrderResponseData",
    "PaginatedEntityOrderResponsePaginationMetadata",
]
...
class PaginatedEntityOrderResponseData(BaseModel):
    id: str
    """ID of the `Order`."""
...
class PaginatedEntityOrderResponsePaginationMetadata(BaseModel):
    """Pagination metadata"""
...
class PaginatedEntityOrderResponse(BaseModel):
    data: List[PaginatedEntityOrderResponseData]
    """List of EntityOrder"""

    pagination_metadata: PaginatedEntityOrderResponsePaginationMetadata
    """Pagination metadata"""
...
V2ListOrdersResponse: TypeAlias = Union[List[UnionMember0], PaginatedEntityOrderResponse]
